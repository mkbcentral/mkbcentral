<x-main-layout>
    <main class="">
        <header class="bg-opacity-80 bg-blue-600 bg-center  h-[600px] text-white"
            ...
            <div class="w-full h-full backdrop-brightness-50 e">
                            ...
                            <div class="flex w-full items-center justify-between px-4">
                                <div>
                                    ...
                                    <nav :class="!navbarOpen && 'hidden'" id="navbarCollapse"
                                        class="absolute right-4  sm:bg-opacity-800 md:bg-opacity-800 top-full w-full max-w-[250px] rounded-lg  py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none">
                                ...
                                <div
                                    class="hidden justify-end bg-blue-600 items-center pr-16 sm:flex lg:pr-0 space-x-6 rounded-lg">
                                    <a href="javascript:void(0)"
                ...
                <div class="flex flex-col container mx-auto px-5 sm:flex-col lg:flex-row md:flex-col">
                    <div class="  flex items-start flex-col justify-center">
                        <h1
                            class="text-2xl md:text-3xl sm:text-2xl sm:text-center md:text-center lg:text-center  text-gray-2">
                            Disponible pour repondre aux des clients</h1>
                        <h2 class="text-3xl md:text-5xl sm:text-3xl">Des logiciels surmesure</h2>
                        <p class="align-baseline pb-12 text-gray-2">Notre plateforme se donne une mission de vous
                            accopanger, dans
                            le
        ...
        <section class=" pt-20  lg:pt-[80px] lg:pb-5">
            <div class="container mx-auto">
                <div class="text-center pb-12">
                    <h1 class="text-5xl">Un logicile pour un besoin</h1>
                </div>
                            ...
                            <div class="p-8 text-center sm:p-9 md:p-7 xl:p-9">
                                <h3>
                                    <a href="javascript:void(0)"
                                        ...
                                        Un logiciel pour le gestion votre école
                                    </a>
                                </h3>
                        ...
                        <div class="mb-10 overflow-hidden rounded-lg bg-white">
                            ...
                            <div class="p-8 text-center sm:p-9 md:p-7 xl:p-9">
                                <h3>
                                    <a href="javascript:void(0)"
                                        class="text-dark hover:text-primary mb-4 block text-xl font-semibold sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px]">
                                        Un logiciel pour la gestion hopital ou center de santé
                                    </a>
                                </h3>
                                <p class="text-body-color mb-7 text-base leading-relaxed">
                                    Lorem ipsum dolor sit amet pretium consectetur adipiscing elit.
        ...
        <section class="bg-indigo-200 py-20 lg:py-[80px]"
            ...
            <div class="text-center pt-12 pb-12">
                <h1 class="text-5xl">Nos clients</h1>
            </div>
            <div class="container mx-auto">
                    ...
                    <div class="w-full px-4">
                        <div class="flex flex-wrap items-center justify-center">
                            <a href="javascript:void(0)"
                                ...
                                <img src="https://cdn.tailgrids.com/2.0/image/assets/images/brands/graygrids.svg"
                                    alt="image" class="h-10 w-full" />
                            </a>
                            <a href="javascript:void(0)"
                                class="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                                <img src="https://cdn.tailgrids.com/2.0/image/assets/images/brands/lineicons.svg"
                                    alt="image" class="h-10 w-full" />
                            </a>
                            <a href="javascript:void(0)"
                                class="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                                <img src="https://cdn.tailgrids.com/2.0/image/assets/images/brands/uideck.svg"
                                    alt="image" class="h-10 w-full" />
                            </a>
                            <a href="javascript:void(0)"
                                class="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                                <img src="https://cdn.tailgrids.com/2.0/image/assets/images/brands/ayroui.svg"
                                    alt="image" class="h-10 w-full" />
                            </a>
                        </div>
                    </div>
        ...
        <footer class="relative z-10 bg-dark text-white pb-10 lg:pt-[120px] lg:pb-20 ">
            <div class="container mx-auto">
                <div class="-mx-4 flex flex-wrap">
                    <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                        <div class="mb-10 w-full">
                            ...
                            <p class="text-white flex items-center text-sm font-medium">
                                ...
                                <span>+012 (345) 97 133 0007</span>
                            </p>
                        </div>
                    </div>
                    <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                        <div class="mb-10 w-full">
                            <h4 class="text-white mb-9 text-lg font-semibold">Logiciels</h4>
                            <ul>
                                <li>
                                    <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                        <div class="mb-10 w-full">
                            <h4 class="text-white mb-9 text-lg font-semibold">Clients</h4>
                            <ul>
                                <li>
                                    <a href="javascript:void(0)"
                                        class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                        Polyclinque shukrani
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                        <div class="mb-10 w-full">
                            <h4 class="text-white mb-9 text-lg font-semibold">Formations</h4>
                            <ul>
                                <li>
                                    <a href="javascript:void(0)"
                                        class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                        Developement mobiele
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                        <div class="mb-10 w-full">
                            ...
                            <p class="text-body-color text-base">&copy; 2025 MKBcentral</p>
                        </div>
                    </div>
                </div>
            </div>
